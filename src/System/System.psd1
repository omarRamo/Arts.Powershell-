#
# Manifeste de module pour le module « Restore-EnvironmentVariables »
#
# Généré par : UT356Y
#
# Généré le : 12/07/2024
#
...
@{
    ...
    GUID              = 'ea784425-fb53-440f-a468-7700b6169ce6'
    ...
    Copyright         = '(c) 2024 Arts. Tous droits réservés.'

    # Description de la fonctionnalité fournie par ce module
    Description       = 'Restore environment variables from file to computer'
    ...
    NestedModules = @("Invoke-SqlScripts.ps1", "Restore-EnvironmentVariables.ps1", "Save-EnvironmentVariables.ps1")
