#
# Manifeste de module pour le module « Get-RemoteSession »
#
# Généré par : Arts
#
# Généré le : 03/07/2024
#
...
@{
    ...
    GUID = '3102d26f-51f1-4826-b72e-7d81d19a8dd2'
    ...
    Description = 'Interact with remote servers'
    ...
    NestedModules = @(
        "Get-RemoteSessions.ps1", 
        "Copy-FilesToRemoteSession.ps1"
        "Send-ConsoleApp.ps1", 
        "Send-AngularApp.ps1",
        "Send-WindowsServiceApp.ps1")
